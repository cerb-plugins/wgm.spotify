...
<fieldset class="peek black" id="{$div_id}">
	<div class="oauth-button" style="padding:10px;background-color:rgb(69,100,189);color:white;display:inline-block;cursor:pointer;">
		...
		<b style="color:white;text-decoration:none;">Linked to {$params.label|default:'a Spotify account'}</b>
		{else}
		<b style="color:white;text-decoration:none;">Link to a Spotify account</b>
		{/if}
	</div>
